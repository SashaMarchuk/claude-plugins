...
Invoke the `interview-handoff:interview-handoff` skill via the Skill tool, passing `--collect $ARGUMENTS`. The skill runs its `## Mode: collect` flow. This command holds no workflow of its own.
